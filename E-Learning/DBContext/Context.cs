...
namespace E_Learning.DBContext
{
    public class Context : DbContext
    {
        ...
        public virtual DbSet<Learning_Result> Learning_Results { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Learning_Result>()
            ...
            modelBuilder.Entity<Student>()
                .HasMany(e => e.Learning_Results)
                .WithOne(e => e.Student1)
                .HasForeignKey(e => e.Student);

            modelBuilder.Entity<Student>()
                .HasMany(e => e.Student_Tests)
                .WithOne(e => e.Student1)
                .HasForeignKey(e => e.Student);
