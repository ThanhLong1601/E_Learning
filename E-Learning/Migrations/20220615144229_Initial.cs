    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_Tests", x => x.studentTestId);
                    table.ForeignKey(
                        name: "FK_Student_Tests_Class_Test_Class_Test",
                        column: x => x.Class_Test,
                        principalTable: "Class_Test",
                        principalColumn: "classTestId");
                    table.ForeignKey(
                        name: "FK_Student_Tests_Student_Student",
                        column: x => x.Student,
                        principalTable: "Student",
                        principalColumn: "studentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Learning_Results", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Learning_Results_Student_Student",
                        column: x => x.Student,
                        principalTable: "Student",
                        principalColumn: "studentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Learning_Results_Student_Tests_Student_Test",
                        column: x => x.Student_Test,
                        principalTable: "Student_Tests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Learning_Results_Student",
                table: "Learning_Results",
                column: "Student");

            migrationBuilder.CreateIndex(
                name: "IX_Learning_Results_Student_Test",
                table: "Learning_Results",
                column: "Student_Test");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_Tests_Class_Test",
                table: "Student_Tests",
                column: "Class_Test");

            migrationBuilder.CreateIndex(
                name: "IX_Student_Tests_Student",
                table: "Student_Tests",
                column: "Student");
